// Package web provides the main web server implementation for the 4y-ui panel,
...
import (
	...
	"github.com/hxehex/4y-ui/v2/web/controller"
	"github.com/hxehex/4y-ui/v2/web/job"
...
// Server represents the main web server for the 4y-ui panel with controllers, services, and scheduled jobs.
type Server struct {
...
func (s *Server) initRouter() (*gin.Engine, error) {
	...
	engine.Use(sessions.Sessions("4y-ui", store))
