// Package entity defines data structures and entities used by the web layer of the 4y-ui panel.
package entity
...
// AllSetting contains all configuration settings for the 4y-ui panel including web server, Telegram bot, and subscription settings.
